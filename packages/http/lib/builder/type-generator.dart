...
String generateApiTypes(Map<String, dynamic> swagger, String prefix) {
  ...
  for (final entry in paths.entries) {
    ...
    final serviceNamespace = operationId.contains('_')
        ? operationId.substring(0, operationId.indexOf('_'))
        : '';
    final opNameNoNs = operationId.replaceFirst('${serviceNamespace}_', 'T');
    ...
    for (final f in fields) {
      if ((f.description ?? '').isNotEmpty) {
        bodyBuf.writeln('  /// ${sanitizeDocComment(f.description)}');
      }
