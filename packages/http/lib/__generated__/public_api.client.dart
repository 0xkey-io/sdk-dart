/* @generated by `zeroxkey_codegen`. DO NOT EDIT BY HAND */
...
class ZeroXKeyClient {
  ...
  /// Authenticate with an OAuth 2.0 provider and receive an OIDC token issued by ZeroXKey in response.
  ///
  ...
  /// Produce a `SignedRequest` from `TValidateSessionBody` by using the client's `stamp` function.
  ///
  /// See also: `ValidateSession`.

  Future<TSignedRequest> stampValidateSession({
    required TValidateSessionBody input,
  }) async {
    final fullUrl = '${config.baseUrl}/internal/v1/validate_session';
    final body = packActivityBody(
      bodyJson: input.toJson(),
      fallbackOrganizationId: input.organizationId ??
          config.organizationId ??
  ...
  /// Produce a `SignedRequest` from `TEmailVerifyInitBody` by using the client's `stamp` function.
  ///
  /// See also: `EmailVerifyInit`.

  Future<TSignedRequest> stampEmailVerifyInit({
    required TEmailVerifyInitBody input,
  }) async {
    final fullUrl = '${config.baseUrl}/public/v1/email_verify_init';
    final body = packActivityBody(
      bodyJson: input.toJson(),
      fallbackOrganizationId: input.organizationId ??
          config.organizationId ??
  ...
  /// Produce a `SignedRequest` from `TInitialSignupBody` by using the client's `stamp` function.
  ///
  /// See also: `InitialSignup`.

  Future<TSignedRequest> stampInitialSignup({
    required TInitialSignupBody input,
  }) async {
    final fullUrl = '${config.baseUrl}/public/v1/initial_signup';
    final body = packActivityBody(
      bodyJson: input.toJson(),
      fallbackOrganizationId: input.organizationId ??
          config.organizationId ??
  ...
  /// Produce a `SignedRequest` from `TSimulatePolicyChainBody` by using the client's `stamp` function.
  ///
  /// See also: `SimulatePolicyChain`.

  Future<TSignedRequest> stampSimulatePolicyChain({
    required TSimulatePolicyChainBody input,
  }) async {
    final fullUrl = '${config.baseUrl}/public/v1/query/simulate_policy_chain';
    final body = packActivityBody(
      bodyJson: input.toJson(),
      fallbackOrganizationId: input.organizationId ??
          config.organizationId ??
  ...
  /// Produce a `SignedRequest` from `TSendLoginLinkBody` by using the client's `stamp` function.
  ///
  /// See also: `SendLoginLink`.

  Future<TSignedRequest> stampSendLoginLink({
    required TSendLoginLinkBody input,
  }) async {
    final fullUrl = '${config.baseUrl}/public/v1/send_login_link';
    final body = packActivityBody(
      bodyJson: input.toJson(),
      fallbackOrganizationId: input.organizationId ??
          config.organizationId ??
  ...
  /// Create a new webhook endpoint for the organization.
  ///
  ...
  /// Update an existing webhook endpoint (url, name, active status).
  ///
