...
enum StorageKeys {
  AllSessionKeys("@zeroxkey/all-session-keys"),
  ActiveSessionKey("@zeroxkey/active-session-key"),
  DefaultSession("@zeroxkey/session"),
  EmbeddedKey("@zeroxkey/embedded-key");
...
const ZEROXKEY_OAUTH_ORIGIN_URL = "https://oauth-origin.0xkey.com";
const ZEROXKEY_OAUTH_REDIRECT_URL = "https://oauth-redirect.0xkey.com";
