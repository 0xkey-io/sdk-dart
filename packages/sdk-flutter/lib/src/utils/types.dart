...
class ZeroXKeyRuntimeConfig extends ZeroXKeyConfig {
  ZeroXKeyRuntimeConfig({
...
class AuthConfig {
  ...
  /** If true, will automatically fetch the WalletKit configuration specified in the ZeroXKey Dashboard upon initialization. Defaults to true. */
