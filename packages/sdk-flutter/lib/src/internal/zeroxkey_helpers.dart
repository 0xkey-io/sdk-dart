...
/// Fetches user details and associated wallets from the ZeroXKey API.
///
...
///
/// [client] The authenticated `ZeroXKeyClient` instance.
...
Future<v1User?> fetchUser(
    ZeroXKeyClient client, String organizationId, String userId) async {
  try {
...
Future<List<Wallet>> fetchWallets(
    ZeroXKeyClient client, String organizationId) async {
  try {
...
CreateSubOrgParams getCreateSubOrgParams(CreateSubOrgParams? createSubOrgParams,
    ZeroXKeyConfig config, OverrideParams overrideParams) {
