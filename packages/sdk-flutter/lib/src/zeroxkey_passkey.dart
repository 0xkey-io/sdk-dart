...
extension PasskeyExtension on ZeroXKeyProvider {
  ...
  Future<LoginWithPasskeyResult> loginWithPasskey({
    ...
    try {
      if (rpId == null || rpId.isEmpty) {
        throw Exception(
            "Relying Party ID (rpId) must be provided either in the method call or in the ZeroXKeyConfig.passkeyConfig");
      }
      ...
      final result = await _container.loginWithPasskeyUseCase.call(
      ...
      return LoginWithPasskeyResult(sessionToken: result.sessionToken);
    } catch (error) {
