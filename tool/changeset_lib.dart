...
/// Updates the version.dart file for the zeroxkey_http package.
/// The file contains a VERSION constant like: const VERSION = "zeroxkey-dart/X.Y.Z";
void writeHttpVersionDart(String newVersion) {
  ...
  final content = 'const VERSION = "zeroxkey-dart/$newVersion";\n';
  ...
  for (final pkg in packages) {
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      for (final entry in internalVersions.entries) {
        ...
        // Match indented dependency lines like "  zeroxkey_encoding: ^0.1.0"
        final regex = RegExp(
